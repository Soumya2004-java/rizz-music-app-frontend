...
class AlkaYagnik extends StatefulWidget {
  const AlkaYagnik({super.key});

  @override
  State<AlkaYagnik> createState() => _AlkaYagnikState();
}

class _AlkaYagnikState extends State<AlkaYagnik> {
  @override
